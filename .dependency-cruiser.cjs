  ...
  forbidden: [
    {
      ...
      to: { path: '^src/(application|catalog|context|git|hooks-mounts|manager|mcp-config|mcp-mounts|mcp-status|paths|routes|runtime|skills-provider|state|types)(/|\\.)' }
    },
    {
    ...
    },
    {
      ...
      to: { path: '^src/(application|client|context|index|manager|routes|runtime|skills-provider)(/|\\.)' }
    },
    {
