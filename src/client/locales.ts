/** zh/en dictionaries for the Agent Plugin Market section. */

export type Dictionary = Record<string, string>

export const zh: Dictionary = {
  nav: 'Agent Plugin 市场',
  subtitle: '发现与安装 Agent Plugin（agent-plugins.org 便携包）',
  searchPh: '搜索 Agent Plugin…',
  tabAll: '全部',
  tabInstalled: '已安装',
  tabUninstalled: '未安装',
  market: '仓库源',
  ...
  loading: '加载中…',
  lspSection: 'LSP 服务',
  editorHint: '仓库源提供 Agent Plugin。本地目录直接读取（实时反映工作树）；git 源克隆到 ~/.dsh/agent-plugins/.sources/<id>。',
  ...
  installedBadge: '已安装',
  uninstall: '卸载',
  uninstallConfirmTitle: '卸载 Agent Plugin',
  uninstallConfirmDesc: '将从已安装列表移除该 Agent Plugin，其技能与 MCP 工具随即停止注入。仓库源克隆保留。',
  ...
  cancel: '取消',
  confirm: '确认',
  empty: '没有匹配的 Agent Plugin',
  installedEmpty: '还没有安装 Agent Plugin',
  loadFail: 'Agent Plugin 目录加载失败，请稍后重试',
  actionFail: '操作失败',
  version: '版本',
  dimensionUser: '用户级',
  ...
  list: '列表',
  openSettings: '在设置中打开',
  rootLabel: 'Agent Plugin 目录',
  dataLabel: 'Agent Plugin 数据目录',
  countAll: '共 {n} 个 Agent Plugin',
  countInstalled: '已装 {n}',
  countEnabled: '启用 {n}',
}

export const en: Dictionary = {
  nav: 'Agent Plugin Market',
