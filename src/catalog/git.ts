...
export async function gitClone(url: string, branch: string | undefined, dest: string, timeoutMs: number = DEFAULT_TIMEOUT_MS): Promise<void> {
...
export async function gitPull(dir: string, timeoutMs: number = DEFAULT_TIMEOUT_MS): Promise<void> {
  try {
