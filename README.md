...
- **Market page**: a `settings.section` in the Web GUI (search, all/installed/uninstalled tabs, source sidebar with add/remove/refresh, suite cards with surface tag counts, enable toggle, refresh, uninstall).
